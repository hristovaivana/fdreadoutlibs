 ...
 */
#ifndef FDREADOUTLIBS_INCLUDE_FDREADOUTLIBS_WIB_RAWWIBTP_HPP_
#define FDREADOUTLIBS_INCLUDE_FDREADOUTLIBS_WIB_RAWWIBTP_HPP_
...
struct RawWIBTp
{
  ...
  // accessors
  size_t get_header_size() { return sizeof(TpHeader); }
  size_t get_frame_size() { return sizeof(TpHeader) + get_nhits() * sizeof(TpData); }
...
#endif // FDREADOUTLIBS_INCLUDE_FDREADOUTLIBS_WIB_RAWWIBTP_HPP_
