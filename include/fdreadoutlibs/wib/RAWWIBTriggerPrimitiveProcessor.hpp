...
namespace dunedaq {
  namespace fdreadoutlibs {
    ...
    class RAWWIBTriggerPrimitiveProcessor : public readoutlibs::TaskRawDataProcessorModel<types::RAW_WIB_TRIGGERPRIMITIVE_STRUCT>
    {
    ...
    public:
      ...
      using rwtp_ptr = fdreadoutlibs::RawWIBTp*;
